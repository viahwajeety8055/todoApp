...
todoModels.create = async (name, email) => {
...
todoModels.read = async (whereParams) => {
  const where = [];
...
todoModels.update = async (updateParams, whereParams) => {
  const where = [];
...
todoModels.delete = async (whereParams) => {
  const where = [];
